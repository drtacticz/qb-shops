...
Config.Products = {
    ...
    ['hardware'] = {
        ...
        { name = 'cleaningkit',       price = 150, amount = 500 },
        { name = 'advancedrepairkit', price = 500, amount = 500, requiredJob = 'mechanic' },
    },
    ['weedshop'] = {
    ...
    ['mining'] = {
        { name = 'pickaxe', price = 500, amount = 100 },
        { name = 'miningdrill', price = 5000, amount = 100 },
        { name = 'mininglaser', price = 10000, amount = 100 },
        { name = 'drillbit', price = 100, amount = 50 },
        { name = 'goldpan', price = 0, amount = 100 },
    },
    ['prison'] = {
        { name = 'sandwich',     price = 4, amount = 500 },
        { name = 'water_bottle', price = 4, amount = 500 },
    },
    ['police'] = {
        { name = 'weapon_pistol',       price = 0, amount = 500, info = { attachments = { { component = 'COMPONENT_AT_PI_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_stungun',      price = 0, amount = 500, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_pumpshotgun',  price = 0, amount = 500, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_smg',          price = 0, amount = 500, info = { attachments = { { component = 'COMPONENT_AT_SCOPE_MACRO_02', label = '1x Scope' }, { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_carbinerifle', price = 0, amount = 500, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' }, { component = 'COMPONENT_AT_SCOPE_MEDIUM', label = '3x Scope' } } } },
        { name = 'weapon_nightstick',   price = 0, amount = 500 },
        { name = 'weapon_flashlight',   price = 0, amount = 500 },
        { name = 'pistol_ammo',         price = 0, amount = 500 },
        { name = 'smg_ammo',            price = 0, amount = 500 },
        { name = 'shotgun_ammo',        price = 0, amount = 500 },
        { name = 'rifle_ammo',          price = 0, amount = 500 },
        { name = 'handcuffs',           price = 0, amount = 500 },
        { name = 'empty_evidence_bag',  price = 0, amount = 500 },
        { name = 'police_stormram',     price = 0, amount = 500 },
        { name = 'armor',               price = 0, amount = 500 },
        { name = 'radio',               price = 0, amount = 500 },
        { name = 'heavyarmor',          price = 0, amount = 500 },
        { name = 'weapon_fireextinguisher', price = 0, amount = 500 },
        { name = 'ifaks',                   price = 0, amount = 1000 },
        { name = 'bandage',                 price = 0, amount = 1000 },
    },
    ['ambulance'] = {
...
Config.Locations = {
    ...
    ['247supermarket10'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(238.95, -897.18, 29.62, 161.84),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
        ...
        ['blipscale'] = 0.6,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(250.02, -882.29, 29.39, 344.87)
    },

    ['247supermarket11'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(160.04, 6641.08, 31.7, 223.41),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
        ...
        ['blipscale'] = 0.6,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(170.42, 6637.48, 31.7, 44.44)
    },
    ...
    ['ltdgasoline6'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(-344.98, -1477.3, 30.76, 178.8),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
        ...
        ['blipscale'] = 0.6,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(-342.73, -1475.12, 30.75, 268.24)
    },

    ['ltdgasoline7'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(645.6, 261.18, 103.3, 329.19),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
        ...
        ['blipscale'] = 0.6,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(642.41, 260.39, 103.3, 57.7)
    },
    ...
    ['mining'] = {
        ['label'] = 'Mining Store',
        ['coords'] = vector4(2569.54, 2720.12, 42.94, 213.87),
        ['ped'] = 'a_m_y_smartcaspat_01',
        ['scenario'] = 'WORLD_HUMAN_AA_SMOKE',
        ['showblip'] = true,
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-basket',
        ['targetLabel'] = 'Open Shop',
